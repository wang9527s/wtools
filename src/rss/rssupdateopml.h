...
public:
    // 更新自己的rss
    static void
    updateBilibili(const QString &rssServer, const QString &vmid, const QString &opmlPath);
    static QString
    updateBilibili_win(const QString &rssServer, const QString &vmid, const QString &opmlPath);
    // 将他人哔哩哔哩的关注列表生成rss
