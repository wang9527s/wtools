...
//    p.fillRect(rect(),Qt::transparent);
    ...
    if (mPosition == ButtonRight){
        triangle.setPoints(3,
                           timeLinePosx-5,bubbleHeight,
                           timeLinePosx+5,bubbleHeight,
                           timeLinePosx,bubbleHeight+bubbleSharpCornersHeight
                           );//三点坐标
    }
    else if (mPosition == TopRight){
        triangle.setPoints(3,
                           timeLinePosx,bubbleHeight,
                           timeLinePosx-5,bubbleHeight+bubbleSharpCornersHeight,
                           timeLinePosx+5,bubbleHeight+bubbleSharpCornersHeight
                           );//三点坐标
    }
